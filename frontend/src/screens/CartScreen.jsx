...
function CartScreen() {
  ...
  const updateCart = async (product_id, price, shipping_amount, color) => {
                        ...
                        <div className="col-md-2 mb-4 mb-md-0">
                          <div className="d-flex justify-content-center align-items-center">
                            <div className="form-outline d-flex">
                              ...
                              />
                              <button onClick={() => updateCart(c.product.id, c.product.price, c.product.shipping_amount, c.color)} className='ms-2 btn btn-primary'><i className='fas fa-rotate-right'></i></button>
                            </div>
                          </div>
